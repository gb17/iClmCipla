...
public class IndexTableActivityE extends CustomListIndexE implements
		OnClickListener {
	...
	public void onClick(View v) {
		...
		if (id == 1 || id == 8 || id == 14 || id == 21)
			...
			TextView tv = new TextView(IndexTableActivityE.this);
			tv.setText(s);
			...
			Button bv = new Button(IndexTableActivityE.this);
	...
	public void openDialog1(int index) {
		final Dialog dialog = new Dialog(IndexTableActivityE.this);
		...
		Display display = ((WindowManager) IndexTableActivityE.this
		...
		listview3.setAdapter(new ImageAdapter(IndexTableActivityE.this));
	...
	public class MyAdapterforspinner extends ArrayAdapter<String> {
		...
		public View getCustomView(int position, View convertView,
				ViewGroup parent) {
			LayoutInflater inflater = (LayoutInflater) IndexTableActivityE.this
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.drawable.ic_action_search:
			Dialog dialog_box = new Dialog(IndexTableActivityE.this);
		...
		case R.drawable.plus:
			final Dialog d = new Dialog(IndexTableActivityE.this);
	...
	public LinearLayout getView() {
		LinearLayout parent = new LinearLayout(IndexTableActivityE.this);
		...
		lv = new ListView(IndexTableActivityE.this);
		lv.setVisibility(View.INVISIBLE);
		lv.setLayoutParams(new android.view.ViewGroup.LayoutParams(
				android.view.ViewGroup.LayoutParams.MATCH_PARENT,
				android.view.ViewGroup.LayoutParams.WRAP_CONTENT));
		adapter = new CustomAdapterForPhysiiSearch(IndexTableActivityE.this,
				dataList);
